...
AFightPawnController::AFightPawnController()
{
...

	{
		...
		SightConfig->SightRadius = 500;  // 반경
		SightConfig->LoseSightRadius = 550.0f;  //인식이 사라지는 반경
...
void AFightPawnController::EnemyFind()
{
	// BlackboardComp->SetValueAsObject(TEXT("EnemyActor"), "??");
}
